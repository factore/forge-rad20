...
Gem::Specification.new do |s|
  ...
  s.license = "MIT"
  s.summary = "The Forge CMS dependency gem for Ruby 2.0."
  s.description = "The Forge CMS dependency gem Ruby 2.0."
  s.email = "admin@factore.ca"
  s.authors = ["Sean Roberts", "Devlin Palmer", "Adrian Duyzer", "Jamie Allen", "Marc Kelsey", "Martin Eckart", "Chad Ingles"]
  ...
  s.add_dependency 'delayed_job_active_record', '0.4.1'
